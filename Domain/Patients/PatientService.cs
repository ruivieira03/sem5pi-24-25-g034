...
namespace Hospital.Domain.Patients
{
    public class PatientService
    {
        ...
        public PatientService(IPatientRepository patientRepository, IUnitOfWork unitOfWork, ILoggingService loggingService, IEmailService emailService, ISystemUserRepository systemUserRepository)
        {
